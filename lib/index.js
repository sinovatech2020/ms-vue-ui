...
var mainvue_type_template_id_99c4cba6_render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "span",
        { staticClass: "btn-text", style: { fontSize: _vm.fontSize } },
    ...
    createWheel: function createWheel(wrapper, i) {
      ...
      if (!this.wheels[i]) {
        ...
        this.wheels[i].on("scrollEnd", function () {
          //滚动完成之后获取当前选取的索引值
          var currentSelectedIndex = _this4.wheels.map(function (wheel) {
            return wheel.getSelectedIndex();
          });

          _this4.changeData(currentSelectedIndex, prevSelectedIndex);

          prevSelectedIndex = currentSelectedIndex;

          _this4.$emit(EVENT_CHANGE, _this4.wheels[i].getSelectedIndex());
        });
      } else {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/areaPicker/src/main.vue?vue&type=template&id=5d8762f8&
var mainvue_type_template_id_5d8762f8_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
          ...
          [
            ...
            _c("div", { staticClass: "picker-content" }, [
              ...
              _c(
                ...
                [
                  _vm.insideData
                    ? _vm._l(_vm.insideData, function(col, index) {
                        return _c("div", { key: index, staticClass: "wheel" }, [
                          _c(
                            "ul",
                            { staticClass: "wheel-scroller" },
...
var mainvue_type_template_id_5d8762f8_staticRenderFns = []
mainvue_type_template_id_5d8762f8_render._withStripped = true


// CONCATENATED MODULE: ./packages/areaPicker/src/main.vue?vue&type=template&id=5d8762f8&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--0!./node_modules/vue-loader/lib??vue-loader-options!./packages/areaPicker/src/main.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
var mainvue_type_script_lang_js_EVENT_CHANGE = "change";


core_esm.use(wheel_esm);
/* harmony default export */ var areaPicker_src_mainvue_type_script_lang_js_ = ({
  name: "MsAreaPicker",
  props: {
    row: {
      type: Number,
  ...
  watch: {
    pickerData: function pickerData(n) {
      if (n) {
        // 初始化数据
        this.changeData(this.selectedIndex, undefined);
      }
  ...
  methods: {
    visibable: function visibable() {
      ...
      if (this.wheels.length === 0 && this.insideData.length !== 0) {
        this.$nextTick(function () {
          ...
          for (var i = 0; i < _this.insideData.length; i++) {
            _this.createWheel(wrapper, i);
          }
        });
      } else {
        //如果有  停止运动  滚动到上一次所选择的
        for (var i = 0; i < this.insideData.length; i++) {
          this.wheels[i].enable();
          this.wheels[i].wheelTo(this.selectedIndex[i]);
        }
      }
    ...
    hide: function hide() {
      //隐藏 移除wheels 对象
      this.$emit("hide", false); // this.show = false;
    ...
    confirm: function confirm() {
      ...
      var pickerData = this.insideData;
      var currentSelectedValue = pickerData.map(function (data, index) {
        return data[currentSelectedIndex[index]];
      });
      this.$emit("confirm", currentSelectedValue);
    ...
    createWheel: function createWheel(wrapper, i) {
      ...
      if (!this.wheels[i]) {
        ...
        var prevSelectedIndex = this.selectedIndex;
        this.wheels[i].on("scrollStart", function () {
          _this2.restPendding();
        });
        this.wheels[i].on("scrollEnd", function () {
          _this2.wheels[i].isMoveing = true; //滚动完成之后获取当前选取的索引值

          var currentSelectedIndex = _this2.wheels.map(function (wheel) {
            return wheel.getSelectedIndex();
          });

          _this2.changeData(currentSelectedIndex, prevSelectedIndex);

          prevSelectedIndex = currentSelectedIndex;

          _this2.$emit(mainvue_type_script_lang_js_EVENT_CHANGE, _this2.wheels[i].getSelectedIndex());
        });
      } else {
        this.wheels[i].refresh();
      }
    ...
    changeData: function changeData(newSelect, oldSelect) {
      ...
      if (this.row === 1) {
        ...
        if (!oldSelect) {
          // 如果没有上一次选中的 遍历 数据 在省数组中追加对象
          mapFun(_provinces2, this.pickerData);
          mapFun(_cityes, this.pickerData[newSelect[0]].cityes);
          mapFun(areas, this.pickerData[newSelect[0]].cityes[newSelect[0]].areas);
          this.insideData = [];
          this.insideData.push(_provinces2, _cityes, areas);
        } else {
          if (newSelect[0] !== oldSelect[0]) {
            _cityes = this.pickerData[newSelect[0]].cityes;
            areas = this.pickerData[newSelect[0]].cityes[newSelect[1]].areas;
            this.insideData.splice(1, 1, _cityes);
    ...
    isMoveing: function isMoveing() {
      return this.wheels.some(function (wheel) {
        return wheel.isMoveing;
      });
    },
    restPendding: function restPendding() {
      this.wheels.forEach(function (wheel) {
        wheel.isMoveing = false;
      });
    },
    selectProiceFun: function selectProiceFun() {}
  }
});

var mapFun = function mapFun(map, arr) {
  arr.forEach(function (item, index) {
    var text = item.provice ? item.provice : item.text;
    map.push({
      text: text,
      value: item.value
    });
...
// CONCATENATED MODULE: ./packages/areaPicker/src/main.vue?vue&type=script&lang=js&
 /* harmony default export */ var packages_areaPicker_src_mainvue_type_script_lang_js_ = (areaPicker_src_mainvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./packages/areaPicker/src/main.vue
...
var areaPicker_src_main_component = normalizeComponent(
  packages_areaPicker_src_mainvue_type_script_lang_js_,
  mainvue_type_template_id_5d8762f8_render,
  mainvue_type_template_id_5d8762f8_staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var areaPicker_src_main_api; }
areaPicker_src_main_component.options.__file = "packages/areaPicker/src/main.vue"
/* harmony default export */ var areaPicker_src_main = (areaPicker_src_main_component.exports);
// CONCATENATED MODULE: ./packages/areaPicker/index.js


areaPicker_src_main.install = function (Vue) {
  Vue.component(areaPicker_src_main.name, areaPicker_src_main);
};

/* harmony default export */ var areaPicker = (areaPicker_src_main);
...
var components = [dialog, packages_button, popup, moke, packages_scroll, switchCell, datePicker, shareSheet, packages_switch, areaPicker];
