...
//
//
/* harmony default export */ var shareSheet_src_mainvue_type_script_lang_js_ = (_name$props$props$dat = {
  name: "MsShareSheet",
  props: {
    value: {
      type: Boolean,
...
}, _defineProperty(_name$props$props$dat, "props", {
  shareTitle: String,
  shareContent: String,
  shareURL: String,
  shareIconURL: String,
...
}), _defineProperty(_name$props$props$dat, "data", function data() {
  return {
    show: false,
    icons: [{
      id: 1,
...
}), _defineProperty(_name$props$props$dat, "watch", {
  value: function value(n) {
    this.show = n;
  }
...
var components = [dialog, packages_button, popup, moke, packages_scroll, switchCell, datePicker, shareSheet];
